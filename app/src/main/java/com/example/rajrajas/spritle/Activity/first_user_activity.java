...
public class first_user_activity extends AppCompatActivity
{
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        username.setText(controller.get_query_string("select Name from Account where Individual_id=1"));
        userphone.setText(controller.get_query_string("select Phone_number from Account where Individual_id=1"));
        useremail.setText(controller.get_query_string("select Email_id from Account where Individual_id=1"));



        Resources res = getResources();
        String mDrawableName =controller.get_query_string("select Drawable_text from Account where Individual_id=1");
